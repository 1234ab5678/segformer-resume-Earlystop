...
class LossHistory():
    def __init__(self, log_dir, model, input_shape, resume):
...
class EvalCallback():
    def __init__(self, net, input_shape, num_classes, image_ids, dataset_path, log_dir, cuda, resume, \
